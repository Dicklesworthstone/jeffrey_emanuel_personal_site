...
/**
 * Math tooltip component for the CMA-ES article.
    ...
    >
      <span className="relative inline-block">
        ...
        <span className="absolute -right-1 -top-1 opacity-0 group-hover/math:opacity-100 transition-opacity">
          <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full bg-orange-500 shadow-lg border border-white/20">
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2 border-b border-white/5 pb-2">
        <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-orange-400/20 text-orange-400">
      ...
      {math.analogy && (
        <div className="rounded-lg bg-orange-400/5 border border-orange-500/10 px-3 py-2 text-[11px] text-slate-300 leading-relaxed">
          <span className="font-bold text-orange-400 uppercase text-[9px] tracking-widest block mb-1">The Intuition:</span>
          {math.analogy}
        </div>
      )}
    </div>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-400/20 to-red-500/20 shadow-xl border border-orange-500/20">
          <Sigma className="h-7 w-7 text-orange-400" />
        </div>
        <div>
          <h3 className="text-2xl font-black text-white tracking-tight">{math.term}</h3>
          <p className="text-sm font-medium text-orange-400 uppercase tracking-widest">{math.short}</p>
        </div>
      </div>
      ...
      <div className="space-y-5">
        ...
        {math.analogy && (
          <div className="rounded-2xl border border-orange-500/20 bg-orange-500/5 p-5 shadow-inner">
            <h4 className="mb-2 text-xs font-black uppercase tracking-[0.2em] text-orange-400">Intuitive Analogy</h4>
        ...
        {math.why && (
          <div className="rounded-2xl border border-amber-500/20 bg-amber-500/5 p-5">
            <h4 className="mb-2 text-xs font-black uppercase tracking-[0.2em] text-amber-400">Why it matters</h4>
            <p className="text-base leading-relaxed text-slate-200">
              {math.why}
            </p>
          </div>
