    ...
    <>
      ...
      >
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          <Link
            href="/tldr"
            className="inline-flex items-center gap-2 rounded-full bg-violet-500/10 px-5 py-2.5 text-sm font-semibold text-violet-400 ring-1 ring-inset ring-violet-500/30 transition-colors hover:bg-violet-500/20 hover:text-violet-300"
          >
          ...
          <Link
            href="/consulting"
            className="inline-flex items-center gap-2 rounded-full bg-white/5 px-5 py-2.5 text-sm font-semibold text-slate-300 ring-1 ring-inset ring-white/10 transition-colors hover:bg-white/10 hover:text-white"
          >
            Work with me
            <ArrowRight className="h-4 w-4" />
          </Link>
