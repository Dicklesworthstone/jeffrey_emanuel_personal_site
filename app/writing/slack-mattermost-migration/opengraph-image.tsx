  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Purple orb - top left behind illustration */}
        <div
          style={{
            position: "absolute",
            top: -180,
        ...
        {/* Cyan orb - center behind illustration */}
        <div
          style={{
            position: "absolute",
            top: 90,
        ...
        {/* Emerald orb - bottom right behind text */}
        <div
          style={{
            position: "absolute",
            bottom: -220,
        ...
        {/* Left — Illustration, framed with a soft glow */}
        <div
          style={{
            display: "flex",
            alignItems: "center",
